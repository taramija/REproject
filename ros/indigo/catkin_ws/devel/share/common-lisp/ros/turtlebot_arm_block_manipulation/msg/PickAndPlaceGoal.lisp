...
(cl:defmethod cl:initialize-instance :after ((m <PickAndPlaceGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PickAndPlaceGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turtlebot_arm_block_manipulation-msg:<PickAndPlaceGoal> is deprecated: use turtlebot_arm_block_manipulation-msg:PickAndPlaceGoal instead.")))

(cl:ensure-generic-function 'frame-val :lambda-list '(m))
(cl:defmethod frame-val ((m <PickAndPlaceGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_arm_block_manipulation-msg:frame-val is deprecated.  Use turtlebot_arm_block_manipulation-msg:frame instead.")
  (frame m))

(cl:ensure-generic-function 'z_up-val :lambda-list '(m))
(cl:defmethod z_up-val ((m <PickAndPlaceGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_arm_block_manipulation-msg:z_up-val is deprecated.  Use turtlebot_arm_block_manipulation-msg:z_up instead.")
  (z_up m))

(cl:ensure-generic-function 'gripper_open-val :lambda-list '(m))
(cl:defmethod gripper_open-val ((m <PickAndPlaceGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_arm_block_manipulation-msg:gripper_open-val is deprecated.  Use turtlebot_arm_block_manipulation-msg:gripper_open instead.")
  (gripper_open m))

(cl:ensure-generic-function 'gripper_closed-val :lambda-list '(m))
(cl:defmethod gripper_closed-val ((m <PickAndPlaceGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_arm_block_manipulation-msg:gripper_closed-val is deprecated.  Use turtlebot_arm_block_manipulation-msg:gripper_closed instead.")
  (gripper_closed m))

(cl:ensure-generic-function 'pickup_pose-val :lambda-list '(m))
(cl:defmethod pickup_pose-val ((m <PickAndPlaceGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_arm_block_manipulation-msg:pickup_pose-val is deprecated.  Use turtlebot_arm_block_manipulation-msg:pickup_pose instead.")
  (pickup_pose m))

(cl:ensure-generic-function 'place_pose-val :lambda-list '(m))
(cl:defmethod place_pose-val ((m <PickAndPlaceGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_arm_block_manipulation-msg:place_pose-val is deprecated.  Use turtlebot_arm_block_manipulation-msg:place_pose instead.")
  (place_pose m))

(cl:ensure-generic-function 'topic-val :lambda-list '(m))
(cl:defmethod topic-val ((m <PickAndPlaceGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_arm_block_manipulation-msg:topic-val is deprecated.  Use turtlebot_arm_block_manipulation-msg:topic instead.")
  (topic m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<PickAndPlaceGoal>)))
  ...
  "turtlebot_arm_block_manipulation/PickAndPlaceGoal")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'PickAndPlaceGoal)))
  "Returns string type for a message object of type 'PickAndPlaceGoal"
  "turtlebot_arm_block_manipulation/PickAndPlaceGoal")
